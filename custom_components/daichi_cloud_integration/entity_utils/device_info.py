"""Device info utilities for daichi_cloud_integration."""
...
def create_device_info(
    ...
    return DeviceInfo(
        ...
        name=name or "Daichi Cloud Climate",
        manufacturer=manufacturer or "Daichi Cloud Climate",
...
def get_device_identifiers(config_entry: ConfigEntry) -> set[tuple[str, str]]:
    ...
    Example:
        ...
        >>> # Returns: {('daichi_cloud_integration', 'entry_id_value')}
    """
