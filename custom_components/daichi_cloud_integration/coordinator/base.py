"""
Core DataUpdateCoordinator implementation for daichi_cloud_integration.
...
from custom_components.daichi_cloud_integration.api import (
...
if TYPE_CHECKING:
    from custom_components.daichi_cloud_integration.data import DaichiCloudClimateConfigEntry


class DaichiCloudClimateDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    config_entry: DaichiCloudClimateConfigEntry
    ...
    async def _async_update_data(self) -> Any:
        ...
        except DaichiCloudClimateApiClientAuthenticationError as exception:
