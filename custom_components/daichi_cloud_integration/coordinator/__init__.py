"""
Data update coordinator package for daichi_cloud_integration.
...
from .base import DaichiCloudClimateDataUpdateCoordinator

__all__ = ["DaichiCloudClimateDataUpdateCoordinator"]
