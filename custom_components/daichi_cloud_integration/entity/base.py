"""
Base entity class for daichi_cloud_integration.
...
from custom_components.daichi_cloud_integration.const import ATTRIBUTION
...
class DaichiCloudClimateEntity(CoordinatorEntity[DaichiCloudClimateDataUpdateCoordinator]):
    """
    Base entity class for daichi_cloud_integration.
