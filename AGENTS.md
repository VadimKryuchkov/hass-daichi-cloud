...
- **Domain:** `daichi_cloud_integration`
- **Title:** Daichi Cloud Climate
- **Repository:** VadimKryuchkov/hass-daichi-cloud

**Key directories:**

- `custom_components/daichi_cloud_integration/` - Main integration code
...
- Integration logs: `custom_components.daichi_cloud_integration: debug` in `config/configuration.yaml`
...
- **Domain:** `daichi_cloud_integration`
- **Title:** Daichi Cloud Climate
- **Class prefix:** `DaichiCloudClimate`

**When creating new files:**

- Use the domain `daichi_cloud_integration` for all DOMAIN references
- Prefix all integration-specific classes with `DaichiCloudClimate`
- Use "Daichi Cloud Climate" as the display title
...
- Inherit from platform base + `DaichiCloudClimateEntity`
...
- `tests/` mirrors `custom_components/daichi_cloud_integration/` structure
