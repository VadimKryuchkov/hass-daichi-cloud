# Getting Started with Daichi Cloud Climate

This guide will help you install and set up the Daichi Cloud Climate custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/VadimKryuchkov/hass-daichi-cloud`
6. Set category to "Integration"
7. Click "Add"
8. Find "Daichi Cloud Climate" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/VadimKryuchkov/hass-daichi-cloud/releases)
2. Extract the `daichi_cloud_integration` folder from the archive
3. Copy it to `custom_components/daichi_cloud_integration/` in your Home Assistant configuration directory
...
4. Select entities from "Daichi Cloud Climate"

Example entities card:

```yaml
type: entities
title: Daichi Cloud Climate
entities:
...
- Report issues at [GitHub Issues](https://github.com/VadimKryuchkov/hass-daichi-cloud/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/VadimKryuchkov/hass-daichi-cloud/discussions)
