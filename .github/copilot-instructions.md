...
- **Main code:** `custom_components/daichi_cloud_integration/`
...
- `entity/` — Base entity class (`DaichiCloudClimateEntity`)
...
- Entity MRO: `(PlatformEntity, DaichiCloudClimateEntity)` — order matters
...
- Debug level: `custom_components.daichi_cloud_integration: debug` in `config/configuration.yaml`
