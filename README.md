...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/VadimKryuchkov/hass-daichi-cloud?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=hass-daichi-cloud&category=integration)
...
1. Download the `custom_components/daichi_cloud_integration/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=daichi_cloud_integration)
...
3. Search for "Daichi Cloud Climate"
...
Find all entities in **Settings** → **Devices & Services** → **Daichi Cloud Climate** → click on the device.
...
### `daichi_cloud_integration.example_action`
...
```yaml
service: daichi_cloud_integration.example_action
data:
  # Add your parameters here
```

### `daichi_cloud_integration.reload_data`
...
```yaml
service: daichi_cloud_integration.reload_data
```
...
logger:
  default: info
  logs:
    custom_components.daichi_cloud_integration: debug
```
...
4. Check the integration diagnostics (Settings → Devices & Services → Daichi Cloud Climate → 3 dots → Download diagnostics)
...
**Made with ❤️ by [@VadimKryuchkov][user_profile]**

---

[commits-shield]: https://img.shields.io/github/commit-activity/y/VadimKryuchkov/hass-daichi-cloud.svg?style=for-the-badge
[commits]: https://github.com/VadimKryuchkov/hass-daichi-cloud/commits/main
[hacs]: https://github.com/hacs/integration
[hacsbadge]: https://img.shields.io/badge/HACS-Default-orange.svg?style=for-the-badge
[license-shield]: https://img.shields.io/github/license/VadimKryuchkov/hass-daichi-cloud.svg?style=for-the-badge
[maintenance-shield]: https://img.shields.io/badge/maintainer-%40VadimKryuchkov-blue.svg?style=for-the-badge
[releases-shield]: https://img.shields.io/github/release/VadimKryuchkov/hass-daichi-cloud.svg?style=for-the-badge
[releases]: https://github.com/VadimKryuchkov/hass-daichi-cloud/releases
